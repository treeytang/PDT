...
class GPS_Signal():
    ...
    def __init__(self, calling_party, callend_party, recv_ip, rcu, lai):
        ...
        self.calling_party = int(calling_party)
        self.callend_party = int(callend_party)
    ...
    def start(self):
        ...
        print(self.calling_party, self.callend_party)

        l = [x for x in range(self.calling_party, self.callend_party)]
        # 获取所有的经纬度可用列表点位
...
def main():
    ...
    callend_party = callend
    # calling_party = 1048777
    # callend_party = 1048977
