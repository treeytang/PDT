...
class GPS_Signal():
    ...
    def __init__(self):
        ...
        recv_ip = "192.168.1.66"
        recv_port = 16889
        send_ip = "192.168.1.249"
        send_port = 6004
        self.Bs_dn = 'r122.pdt.cn'
        self.lai = '122'
        ...
        self.rcu_north = 28.21725
        self.rcu_east = 120.5198
    ...
    def start(self):
        ...
        while True:
            ...
            counts = 0
            # 筛选出需要变动的用户
            for user in range(40022200, 40022900):
                # 标记需要变动的用户
                flag = random.choice(range(0, 2))
                if flag == 1:
                    counts += 1
                if counts > (len(range(40022200, 40022900)) // 3):
                    flag = 0
