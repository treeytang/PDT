...
class GPS_Signal():
    ...
    def send_signal(self, user, dic):
        ...
        send_data = "GPGLL,{},{},N,{},E,A,500,,{},<5%,{},I,15,,32820954,,,{},{},,,,,,,".format(user,norths,easts,self.utc_time(), upstream_fs, self.Bs_dn, self.lai)
        if int(count)%2==0:
            send_data = "GPGLL,{},{},N,{},E,A,500,,{},{},{},I,15,,32820954,,,{},{},,,,,,,".format(user,norths,easts,self.utc_time(),down_fs, upstream_fs, self.Bs_dn, self.lai)
        a = 0
        for i in send_data:
            a = a ^ (ord(i))
